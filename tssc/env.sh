...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/github-tests-go-xazunrlt:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/github-tests-go-xazunrlt-gitops
